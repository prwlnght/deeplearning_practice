...
n_classes = 10
batch_size = 100  # batches of 100 examples to manipulate the weights

# use as placeholders for varied input
x = tf.placeholder('float', [None, 784])  # flatten the images into a vector map
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(hm_epochs):
            ...
            for _ in range(int(mnist.train.num_examples / batch_size)):
                epoch_x, epoch_y = mnist.train.next_batch(batch_size)  # chunks through the data, mnist
        ...
        print('Accuracy', accuracy.eval({x: mnist.test.images, y: mnist.test.labels}))  # get test accuracy
